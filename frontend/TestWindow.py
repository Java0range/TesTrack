...
"}")
        ...
        self.save_Button.setGeometry(QtCore.QRect(730, 650, 111, 51))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.save_Button.setFont(font)
        self.save_Button.setObjectName("save_Button")
        self.otvet_input = QtWidgets.QLineEdit(parent=self.widget)
        self.otvet_input.setGeometry(QtCore.QRect(430, 660, 291, 41))
        self.otvet_input.setObjectName("otvet_input")
        self.marker_Button = QtWidgets.QPushButton(parent=self.widget)
        self.marker_Button.setGeometry(QtCore.QRect(310, 650, 111, 51))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.label.setGeometry(QtCore.QRect(0, 0, 1101, 651))
        self.label.setText("")
